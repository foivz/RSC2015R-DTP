 ...
 */
package hr.foi.rsc.configurations;

import hr.foi.rsc.filters.CorsFilter;
import hr.foi.rsc.services.PersonDetailsService;
            ...
            public void configure(HttpSecurity http) throws Exception {
                    http
                            .authorizeRequests()
                                    ...
                                    .antMatchers("/notification/*").anonymous()
